...
![Sınıf Dağılımı](sinif-dagilimi.png)

*Veri Setinden Rastgele Örnek Görüntüler:*
![Örnek Görüntüler](rastgele-gorsel.png)
...
![Eğitim Grafikleri](dogruluk-grafikleri.png)
...
![Karmaşıklık Matrisi](karmasiklik-matrisi.png)
...
![Aktivasyon Haritası](conv2d_2.png)
